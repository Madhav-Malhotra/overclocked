...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    CData/*7:0*/ top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h05df82ad__0;
    top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h05df82ad__0 = 0;
    IData/*23:0*/ top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h1a8d80be__0;
    top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h1a8d80be__0 = 0;
    ...
    VL_READMEM_N(true, 32, 262144, 0, VL_CVT_PACK_STR_NW(26, Vtop__ConstPool__CONST_h480d57c4_0)
    ...
    VL_READMEM_N(true, 32, 139, 0, VL_CVT_PACK_STR_NW(26, Vtop__ConstPool__CONST_h480d57c4_0)
                 ,  &(vlSelf->top__DOT__dut__DOT__core__DOT__dmem1__DOT__temp)
                 , 0, ~0ULL);
    top__DOT__dut__DOT__core__DOT__dmem1__DOT__i = 0U;
    while (VL_GTS_III(32, 0x8bU, top__DOT__dut__DOT__core__DOT__dmem1__DOT__i)) {
        top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h05df82ad__0 
            = (((0x8aU >= (0xffU & top__DOT__dut__DOT__core__DOT__dmem1__DOT__i))
                 ? vlSelf->top__DOT__dut__DOT__core__DOT__dmem1__DOT__temp
                [(0xffU & top__DOT__dut__DOT__core__DOT__dmem1__DOT__i)]
                 : 0U) >> 0x18U);
        top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h1a8d80be__0 
            = ((0x8aU >= (0xffU & top__DOT__dut__DOT__core__DOT__dmem1__DOT__i))
        ...
        vlSelf->top__DOT__dut__DOT__core__DOT__dmem1__DOT__mem[(0xfffffU 
                                                                & ((IData)(2U) 
                                                                   + 
                                                                   VL_MULS_III(32, (IData)(4U), top__DOT__dut__DOT__core__DOT__dmem1__DOT__i)))] 
            = (0xffU & (top__DOT__dut__DOT__core__DOT__dmem1__DOT____Vconcswap_1_h1a8d80be__0 
                        >> 0x10U));
        vlSelf->top__DOT__dut__DOT__core__DOT__dmem1__DOT__mem[(0xfffffU 
                                                                & ((IData)(1U) 
                                                                   + 
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 139; ++__Vi0) {
