...
_start:
    ...
    addi	x1,x0,0
    addi	x2,x0,1
    bne	x1,x2,_start+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_3
    bne	x1,x2,_start+0x14
    bne	x0,x3,fail
...
test_3:
    ...
    addi	x1,x0,1
    addi	x2,x0,0
    bne	x1,x2,test_3+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_4
    bne	x1,x2,test_3+0x14
    bne	x0,x3,fail
...
test_4:
    ...
    addi	x1,x0,-1
    addi	x2,x0,1
    bne	x1,x2,test_4+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_5
    bne	x1,x2,test_4+0x14
    bne	x0,x3,fail
...
test_5:
    ...
    addi	x1,x0,1
    addi	x2,x0,-1
    bne	x1,x2,test_5+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_6
    bne	x1,x2,test_5+0x14
    bne	x0,x3,fail
