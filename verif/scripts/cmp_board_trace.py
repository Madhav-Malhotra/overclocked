...
def compare_files(test_file_path, golden_file_path, output_file_path, mismatch_only=False, filter_prefix="[W]"):
    ...
    with open(output_file_path, 'w') as out:
        ...
        for i in range(num_lines):
            ...
            test_line = test_lines[i-1].rstrip('\n') if i < len(test_lines) else ""
...
if __name__ == "__main__":
    ...
    print(f'Comparing {test_file} against {golden_file}')
