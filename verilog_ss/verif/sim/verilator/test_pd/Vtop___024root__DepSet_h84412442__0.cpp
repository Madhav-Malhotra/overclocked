...
void Vtop___024root____Vdpiexp_top__DOT__clkg__DOT__toggleClock_TOP(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP.top__DOT__clkg__DOT__clk = (1U & (~ (IData)(vlSymsp->TOP.top__DOT__clkg__DOT__clk)));
}
...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vdpi_export_trigger = 0U;
    vlSelf->__VactTriggered.set(1U, ((~ (IData)(vlSelf->top__DOT__clock)) 
                                     & (IData)(vlSelf->__Vtrigprevexpr___TOP__top__DOT__clock__0)));
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->top__DOT__clkg__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__DOT__clkg__DOT__clk__0))));
    vlSelf->__VactTriggered.set(3U, ((IData)(vlSelf->top__DOT__clock) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__DOT__clock__0))));
