...
_start:
    ...
    addi	x1,x0,0
    addi	x2,x0,1
    bltu	x1,x2,_start+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_3
    bltu	x1,x2,_start+0x14
    bne	x0,x3,fail
...
test_3:
    ...
    addi	x1,x0,-2
    addi	x2,x0,-1
    bltu	x1,x2,test_3+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_4
    bltu	x1,x2,test_3+0x14
    bne	x0,x3,fail
...
test_4:
    ...
    addi	x1,x0,0
    addi	x2,x0,-1
    bltu	x1,x2,test_4+0x18
    bne	x0,x3,fail
    bne	x0,x3,test_5
    bltu	x1,x2,test_4+0x14
    bne	x0,x3,fail
...
test_8:
    ...
    lui	x2,0x80000
    addi	x2,x2,-1
    bltu	x1,x2,test_8+0x18
    bne	x0,x3,test_8+0x1c
    bne	x0,x3,fail
    bltu	x1,x2,test_8+0x18
